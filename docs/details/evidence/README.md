...
- memory：`memory/deepseek_v41_csa2_kv_bytes.md`、`glm5next_minimax_m3_cache.md`、`kimi_k3_kda_state.md`、`sglang_width_kv.md`、`deepseek_v4_v41_a100_boundary.md`（⛔ fp8/fp4 前向留 H20）。
