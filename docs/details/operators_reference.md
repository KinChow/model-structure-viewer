...
（=vector/4）、HBM 2.039 TB/s → 1.427 TB/s（η_hbm=0.7，算子成本校准）；comm=0（actions 无
...
| `rmsnorm` | prefill | 216/214 | 0 | 1.369e+9 | 4.383e+5 | 3.343e+5 | 6.847e+8 | 6.847e+8 | 0.00 | memory | 计算✓ 字节✓ | 1.175e+8 | 0 |
