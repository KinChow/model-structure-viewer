...
- [显存估计理论口径](details/memory_estimation_theory.md)：T0/T1/T2/T3/U 分类、组成项、公式和准确性边界
- [显存估计实现边界](details/memory_estimation_implementation.md)：当前代码映射、vLLM/SGLang adapter 和 evidence 采集协议
- [显存估计系统设计](details/memory_estimation_design.md)：理论账、运行时账、fingerprint、UI 和分阶段落地
