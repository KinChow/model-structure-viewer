...
// `model_executor/models/registry.py` 里有 `DeepseekV32MTPModel` /
...
export function mtpModule(id, normalized, { attentionKind, layerKind }) {
  ...
  return withShapeDims(moduleSpec(
    ...
    [
      rmsNormModule(`${id}.enorm`, "embedding norm", normalized, "attn_norm"),
      rmsNormModule(`${id}.hnorm`, "hidden norm", normalized, "attn_norm"),
      ...
      rmsNormModule(`${id}.shared_head_norm`, "shared head norm", normalized, "output_norm"),
    ],
