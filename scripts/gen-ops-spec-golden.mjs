...
import { buildSpecTreeMap, hashSpecTree } from "../frontend/src/structure/model_executor/__tests__/opsSpecTreeGoldenLib.js";
...
console.log(`written ${Object.keys(hashes).length} model hashes -> ${path.relative(process.cwd(), outPath)}`);
