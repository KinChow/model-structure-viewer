...
| architectures[0] | normMode | linearAttentionMode | visionInternalMerger | sharedExpertsAreFused | moeClass | visionAttr | decoderLayerClass | mlpClass | rmsNormClass | attentionClass | modelClass | ffn | visionBlockClass | visionModelClass | layersAttr | attention | gatedResidualClass | pleClass |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| `MiniMaxM3SparseForConditionalGeneration` | `gemma_rmsnorm` | — | — | — | `MiniMaxM3VLSparseMoeBlock` | `vision_tower` | `MiniMaxM3VLDecoderLayer` | `MiniMaxM3VLDenseMLP` | `MiniMaxM3VLRMSNorm` | `MiniMaxM3VLAttention` | `MiniMaxM3VLTextModel` | — | `MiniMaxM3VLVisionEncoderLayer` | `MiniMaxM3VLVisionModel` | `language_model` | — | — | — |
...
| `Qwen4ExpForConditionalGeneration` | — | `qwen4_exp` | ✓ | — | `Qwen4ExpTextSparseMoeBlock` | `visual` | `Qwen4ExpTextDecoderLayer` | `Qwen4ExpTextMLP` | `Qwen4ExpTextRMSNorm` | `linear=Qwen4ExpTextGatedDeltaNet, qsa=Qwen4ExpTextAttention, gqa=Qwen4ExpTextAttention` | — | — | — | — | — | `linear=linear_attn` | `Qwen4ExpTextGatedResidual` | `Qwen4ExpTextPLELayer` |
