    ...
    <main className={`detail-page theme-${theme}`}>
      ...
      <section className="detail-layout">
        <div className="detail-main">
          ...
          {costOpen && <div className="detail-cost-panel"><CostSummary structure={structure} chips={chips} onAddChip={onAddChip} language={language} lenses={activeLenses} onLensesChange={setActiveLenses} phase={activePhase} onPhaseChange={setActivePhase} mode={activeMode} onModeChange={setActiveMode} /></div>}
          <ArchitectureTab structure={structure} zoom={zoom} onZoomChange={onZoomChange} fitNonce={fitNonce} onFit={onFit} selectedPath={selectedPath} matchedPaths={matchedPaths} expandedGroups={expandedGroups} searchActive={Boolean(searchTerm.trim())} hitCount={matchedPaths.size} onSelectNode={onSelectNode} onToggleGroup={onToggleLayerPath} onExpandAllGroups={onExpandAllLayers} onCollapseAllGroups={onCollapseAllLayers} chips={chips} onAddChip={onAddChip} activeLenses={activeLenses} activePhase={activePhase} activeMode={activeMode} compactControls />
